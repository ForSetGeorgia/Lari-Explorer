...
### BEGIN INIT INFO
# Provides:          Lari-Explorer_unicorn_initialization
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Lari-Explorer unicorn initialization
...
APP_ROOT=/home/deploy/Lari-Explorer/current # path to application current folder
