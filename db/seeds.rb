...
<p>
For you programmers out there, we have exposed the data via an open <a href="/en/api" target="_blank">API</a> and you are welcome to use it. We\'d love to hear from you on why and how you are using the API and what we can do to make this service better.
</p>
<p>
If you\'d like to learn more about this and other JumpStart tools, please don\'t hesitate to <a href="http://jumpstart.ge/en/contact-us" target="_blank">contact us!</a> We\'d love to hear and collaborate with you.
</p>
<p>
In the end, data is what you make of it!
</p>
')
  p.page_content_translations.create(:locale => 'ka', :title => "შესახებ", :content => '<p>2014 წლის ნოემბრიდან 2015 წლის თებერვლამდე ლარის ღირებულება აშშ დოლართან მიმართებაში 18.8%-ით შემცირდა. ლარის ღირებულების დაცემის ზუსტი მიზეზები გაურკვეველია, თუმცა ცხადია, რომ ლარის არასტაბილური მდგომარეობა ადამიანების ცხოვრებაზე გავლენას ახდენს. ამ პერიოდში ათასი ლარის ღირებულება ამერიკულ დოლარში 102 დოლარით შემცირდა. არ გვაქვს მონაცემები, რამდენ ადამიანს აქვს ბანკის ვალი, თუმცა ცნობილია, რომ იპოთეკური თუ სხვა სესხების უმეტესობა აშშ დოლარშია, ხალხს კი შემოსავალი ლარში აქვს. ყველა სხვა სირთულესთან ერთად, ეს ძალიან ართულებს მათთვის საკუთარი ფინანსური ვალდებულებების შესრულებას.</p>
<p>ლარის გზამკვლევი განვითარდა ჩვენი <a href="http://feradi.info/ka/visualizations/niakhuri-1-piloti-qartveli-palavani" target="_blank">კომიქსისა </a> და წინა <a href="http://feradi.info/ka/visualizations/2014-2015-tslis-zamtarshi-laris-gaupasurebis-kalkulatori" target="_blank">ლარის გაუფასურების კალკულატორის </a> შედეგად. იგი მომხმარებლებს ახალ ფუნქციებს სთავაზობს, რომელთა საშუალებითაც შესაძლებელია მათთვის საინტერესო დროის მონაკვეთში ლარის ღირებულების ცვლილებების ნახვა სხვადასხვა ვალუტასთან მიმართებით. მონაცემები აღებულია <a href="https://www.nbg.gov.ge/index.php?m=2&amp;lng=geo" target="_blank">საქართველოს ეროვნული ბანკის</a> საიტიდან და განახლდება ყოველდღიურად.</p>
<p>ასევე, ვალუტის კურსის მონაცემებს ვაგროვებთ ოთხი ბანკის საიტიდან, თუმცა ვგეგმავთ მათი რაოდენობის გაზრდას. კომერციული ბანკების ვალუტის გაცვლის კურსების ერთ ადგილას თავმოყრით, გვინდა, ხალხს გავუადვილოთ მათი შედარება და უკეთესი გადაწყვეტილებების მიღება. სამომავლოდ გვსურს კომერციული ბანკების გვერდს ვალუტის კურსების არქივიც დავამატოთ, რათა მომხმარებელს ისტორიული პერსპექტივის დანახვის საშუალებაც მიეცეს.</p>
<p>პროგრამისტებო, თქვენთვის მონაცემები ხელმისაწვდომი გავხადეთ <a href="/ka/api" target="_blank">API</a>-ის საშუალებით და მივესალმებით მის გამოყენებას. გვსურს, თქვენგან გავიგოთ რისთვის და როგორ იყენებთ და შეგვიძლია თუ არა მისი კიდევ უფრო გაუმჯობესება.</p>
<p>თუ გსურთ, მეტი გაიგოთ ლარის გზამკვლევისა და ჯამპსტარტის სხვა ხელსაწყოების შესახებ, <a href="http://jumpstart.ge/ka/contact-us" target="_blank">დაგვიკავშირდით !</a></p>
<p>საბოლოო ჯამში, მონაცემების მნიშვნელობას ის განსაზღვრავს, თუ რა გამოყენებას მოუნახავთ მას!</p>
')
end
if PageContent.where(id: 2).blank?
  ...
  <div class="url">http://lari.jumpstart.ge/[locale]/api/[version]/</div>
  <p>where:</p>
  ...
  p.page_content_translations.create(:locale => 'ka', :title => 'ლარის გზამკვლევის API', :content => '<p>ლარის გზამკვლევის API საშუალებას გაძლევთ, მიიღოთ ინფორმაცია საქართველოს ეროვნული ბანკის მიერ განსაზღვრული  და საქართველოს კომერციულ ბანკებში არსებული უცხოური ვალუტების კურსების შესახებ, ასევე, სხვა მონაცემები, რომლებიც მოცემულია ლარის გზამკვლევის ვებ-გვერდზე.</p>
...
<p>ქვემოთ მოცემული სია წარმოადგენს გამოძახიების სიას, რომელიც ხელმისაწვდომია API-ის თითოეული ვერსიისთვის.</p>')
end
...
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/nbg_currencies</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<div class="url"><a href="/en/api/v1/nbg_currencies" target="_blank">http://lari.jumpstart.ge/en/api/v1/nbg_currencies</a></div>
...
<p>დაბრუნებული ობიექტი იქნება ვალუტების JSON მასივი შემდეგი ინფორმაციით:</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
...
<tr>
<td>name</td>
<td>ვალუტის სახელი</td>
</tr>
<tr>
<td>ratio</td>
<td>ვალუტის ნომერი 1 ლართან მიმართებაში (მაგ., 1 აშშ დოლარიდან 1 ლარში)</td>
</tr>
</tbody>
</table>
<h2>მაგალითები</h2>
<h3>მაგალითი 1</h3>
<p>აქ მოცემულია ყველა ვალუტის მიღების მაგალითი, რომელიც მიღებულია ეროვნული ბანკიდან. URL არის შემდეგი:</p>
<div class="url"><a href="/en/api/v1/nbg_currencies" target="_blank">http://lari.jumpstart.ge/en/api/v1/nbg_currencies</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  results: [
...
<h2>URL</h2>
<p>To call this method, use an HTTP GET request to the following URL:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/nbg_rates</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<div class="url"><a href="/en/api/v1/nbg_rates?currency=USD" target="_blank">http://lari.jumpstart.ge/en/api/v1/nbg_rates?currency=USD</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  result: [
    {
...
<div class="url"><a href="/en/api/v1/nbg_rates?currency=USD&amp;start_date=1391212800000&amp;end_date=1422748800000" target="_blank">http://lari.jumpstart.ge/en/api/v1/nbg_rates?currency=USD&amp;start_date=1391212800000&amp;end_date=1422748800000</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  result: [
    {
...
<div class="url"><a href="/en/api/v1/nbg_rates?currency=USD,GBP" target="_blank">http://lari.jumpstart.ge/en/api/v1/nbg_rates?currency=USD,GBP</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  result: [
    {
...
<tr>
<td>currency</td>
<td>ვალუტის კოდი გაცვლითი კურსის მისაღებად. შეიძლება მოწოდებული იყოს ერთი ვალუტის კოდი (მაგ., USD) ან ერთობლივად განცალკევებული სიით (მაგ., USD,EUR,GBP).</td>
</tr>
</tbody>
</table>
<h2>არჩევითი პარამეტრები</h2>
<p>მოცემული პარამეტრები არჩევითია და შეიძლება გამოყენებულ იქნას სასურველი მონაცემების შესამცირებლად. ამ შემთხვევაში საწყისი თარიღი (start_date) და დასრულების თარიღი (end_date) უნდა იყოს მოცემული, რათა მოხდეს თარიღების გაფილტვრა. თუ თარიღები არ იქნება მოცემული, ყველა გაცვლითი კურსი დაბრუნდება.</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
<tr><th>პარამეტრი</th><th>აღწერა</th></tr>
</thead>
...
<tr>
<td>start_date</td>
<td>გაცვლითი კურსის ინფორმაციის მიღების საწყისი თარიღი, UTC ფორმატში (მაგ., 1422748800000 არის UTC თარიღი 2015-01-01-სთვის) <a href="http://www.w3schools.com/jsref/jsref_utc.asp" target="_blank">UTC-ს თარიღების შესახებ დამატებითი ინფორმაციის მიღება შესაძლებელია ამ ბმულზე.</a></td>
</tr>
<tr>
<td>end_date</td>
<td>გაცვლითი კურსის ინფორმაციის მიღების ბოლო თარიღი, UTC ფორმატში (მაგ., 1422748800000 არის UTC თარიღი 2015-01-01-სთვის) <a href="http://www.w3schools.com/jsref/jsref_utc.asp" target="_blank">UTC-ს თარიღების შესახებ დამატებითი ინფორმაციის მიღება შესაძლებელია ამ ბმულზე.</a></td>
</tr>
</tbody>
</table>
<h2>რას მიიღებთ</h2>
...
<tr>
<td>ratio</td>
<td>ვალუტის ნომერი 1 ლართან მიმართებაში (მაგ., 1 USD-დან  1 GEL-ში)</td>
</tr>
<tr>
<td>rates</td>
<td>გაცვლითი კურსის მასივი მოთხოვნილი თარიღების შუალედში, ან თუ თარიღები არ არის მოთხოვნილი, ფაილში არსებული ყველა კურსისთვის.</td>
</tr>
</tbody>
</table>
<h2>მაგალითები</h2>
...
<h2>URL</h2>
<p>To call this method, use an HTTP GET request to the following URL:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/commercial_banks</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<div class="url"><a href="/en/api/v1/commercial_banks" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_banks</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  results: [
    {
...
<p> </p>')
  m.api_method_translations.create(locale: 'ka', title: 'კომერციული ბანკები', content: '<p>შესაძლებელია იმ კომერციული ბანკების სიის მიღება, რომლების ყიდვა-გაყიდვის მონაცემებიც მოპოვებულია. თითოეული ბანკისთვის, აგრეთვე, მოცემულია იმ ვალუტების სია, რომელთა გაცვლის კურსსაც აქვეყნებს ბანკი. </p>
<h2>URL</h2>
<p>ამ მეთოდის გამოძახებისთვის გამოიყენეთ HTTP GET მოთხოვნა შემდეგი URL-სთვის:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/commercial_banks</div>
<p>სადაც:</p>
<ul class="list-unstyled">
<li>[locale] = ენა, რომელშიც გსურთ მონაცემების გადაყვანა (ამ დროისთვის <strong>ka</strong> ქართულად ან <strong>en</strong> ინგლისურად)</li>
</ul>
<h2>აუცილებელი პარამეტრები</h2>
<p>გამოძახებისთვის არ არის საჭირო აუცილებელი პარამეტრები.</p>
<h2>არჩევითი პარამეტრები</h2>
<p>გამოძახებისთვის არ არის საჭირო არჩევითი  პარამეტრები.</p>
<h2>რას მიიღებთ</h2>
<p>დაბრუნებული ობიექტი იქნება JSON მასივი ბანკების შესახებ შემდეგი ინფორმაციით</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
<tr><th>პარამეტრი</th><th>აღწერა</th></tr>
</thead>
...
<tr>
<td>currencies</td>
<td>კურსების კოდების მასივი, რომელთა ვალუტაც აქვს გამოქვეყნებული ბანკს</td>
</tr>
</tbody>
</table>
<h2>მაგალითები</h2>
<h3>მაგალითი 1</h3>
<p>აქ მოცემულია საიტზე არსებული ყველა ბანკის მიღების მაგალითი. მისი URL არის შემდეგი:</p>
<div class="url"><a href="/en/api/v1/commercial_banks" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_banks</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  results: [
...
<h2>URL</h2>
<p>To call this method, use an HTTP GET request to the following URL:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/commercial_banks_with_currency</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<div class="url"><a href="/en/api/v1/commercial_banks_with_currency?currency=USD" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_banks_with_currency?currency=USD</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  results: [
    {
...
<tr>
<td>currency</td>
<td>ვალუტის კოდი, რათა ვნახოთ რომელ ბანკებში ხდება მათი გადაცვლა</td>
</tr>
</tbody>
</table>
<h2>არჩევითი პარამეტრები</h2>
...
<h2>მაგალითები</h2>
<h3>მაგალითი 1</h3>
<p>მაგალითისთვის მოცემულია ყველა იმ ბანკის მიღება, რომელიც ყიდის ან ყიდულობს USD-ს. მისი URL არის შემდეგი:</p>
<div class="url"><a href="/en/api/v1/commercial_banks_with_currency?currency=USD" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_banks_with_currency?currency=USD</a></div>
<pre class="brush:js;auto-links:false;toolbar:false;tab-size:2" contenteditable="false">{
  valid: true,
  results: [
...
<h2>URL</h2>
<p>To call this method, use an HTTP GET request to the following URL:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/commercial_bank_rates</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<tr>
<td>bank</td>
<td>The code of the bank to get exchange rates from. Can provide one bank code (e.g., BAGA) or a comma separated list (e.g., BAGA,TBCBT)</td>
</tr>
</tbody>
</table>
<p> </p>
...
<div class="url"><a href="/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA</a></div>
...
<div class="url"><a href="/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA&amp;start_date=1391212800000&amp;end_date=1422748800000" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA&amp;start_date=1391212800000&amp;end_date=1422748800000</a></div>
<pre class="brush:js;auto-links:false;toolbar:false" contenteditable="false">{
  valid: true,
  result: [
    {
...
<h3>Example 3</h3>
<p>Here is an example of getting the buy and sell exchange rates on file for the U.S. Dollar at the Bank of Georgia and TBCBT Bank. The URL for this is the following:</p>
<div class="url"><a href="/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA,TBCBT" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA,TBCBT</a></div>
<pre class="brush:js;auto-links:false;toolbar:false" contenteditable="false">{
  valid: true,
  result: [
    {
...
<p> </p>
')
  m.api_method_translations.create(locale: 'ka', title: 'კომერციული ბანკის კურსები', content: '<p>კომერციული ბანკების მიერ დადგენილი ვალუტის ყიდვისა და გაყიდვის კურსების მიღება. შედარებისთვის, აგრეთვე, დაბრუნდება საქართველოს ეროვნული ბანკის მიერ შეთავაზებული სავალუტო კურსები. </p>
<h2>URL</h2>
<p>ამ მეთოდის გამოძახებისთვის გამოიყენეთ HTTP GET მოთხოვნა შემდეგი URL-ისთვის:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/commercial_bank_rates</div>
<p>სადაც:</p>
...
<tr>
<td>currency</td>
<td>ვალუტის კოდი, რათა მიიღოთ ინფორმაცია გაცვლითი კურსის შესახებ (მაგ. USD)</td>
</tr>
<tr>
<td>bank</td>
<td>იმ ბანკის კოდი, საიდანაც ვიღებთ გაცვლით კურსს. შეიძლება მოცემული იყოს ერთი ბანკის კოდი (მაგ. BAGA) ან ერთობლივად განცალკევებული სიით (მაგ., BAGA,TBCB)</td>
</tr>
</tbody>
</table>
<h2>არჩევითი პარამეტრები</h2>
<p>მოცემული პარამეტრები არჩევითია და შეიძლება გამოყენებულ იქნას სასურველი მონაცემების შესამცირებლად. ამ შემთხვევაში ორივე საწყისი თარიღი (start_date) და დასრულების თარიღი (end_date) უნდა იყოს მოცემული, რათა მოხდეს თარიღების გაფილტვრა. თუ თარიღები არ იქნება მოცემული, ყველა გაცვლითი კურსი დაბრუნდება.</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
<tr><th>პარამეტრი</th><th>აღწერა</th></tr>
</thead>
...
<tr>
<td>id</td>
<td>ბანკის კოდი, ვალუტის კოდი და ის, <strong>data</strong> ყიდვის კურსს შეიცავს, თუ - გაყიდვისას</td>
</tr>
<tr>
<td>code</td>
<td>ბანკის კოდი</td>
...
<tr>
<td>rate_type</td>
<td><strong>data-ში</strong> მითითებული კურსი მოცემულია ყიდვის ან გაყიდვის ფორმატში. შესაძლო ღირებულებებია: ყიდვა, გაყიდვა</td>
</tr>
<tr>
<td>color</td>
<td>ფერი, რომელიც გამოყენებულია ცხრილში ბანკის აღსანიშნად.</td>
</tr>
<tr>
<td>dashStyle</td>
<td>ხაზების სტილის გამოყენება ცხრილში არსებული მონაცემებისთვის.</td>
</tr>
<tr>
<td>legendIndex</td>
<td>ლეგენდის ინდექსი ცხრილში მოცემული ჯგუფებისთვის</td>
</tr>
<tr>
<td>data</td>
<td>გაცვლითი კურსის მასივი მოთხოვნილი თარიღების მონაკვეთში, ან თუ თარიღები არ არის მითითებული, ფაილში არსებული ყველა კურსისთვის.</td>
</tr>
</tbody>
</table>
<h2>მაგალითები</h2>
...
<div class="url"><a href="/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA,TBCB" target="_blank">http://lari.jumpstart.ge/en/api/v1/commercial_bank_rates?currency=USD&amp;bank=BAGA,TBCB</a></div>
<pre class="brush:js;auto-links:false;toolbar:false" contenteditable="false">{
  valid: true,
  result: [
    {
...
<h2>URL</h2>
<p>To call this method, use an HTTP GET request to the following URL:</p>
<div class="url">http://lari.jumpstart.ge/[locale]/api/v1/calculator</div>
<p>where:</p>
<ul class="list-unstyled">
<li>[locale] = the locale of the language you want the data to be returned in (currently <strong>ka</strong> for Georgian or <strong>en</strong> for English)</li>
</ul>
...
<div class="url"><a href="/en/api/v1/calculator?currency=USD&amp;amount=1000&amp;direction=1&amp;start_date=1422748800000&amp;end_date=1425168000000" target="_blank">http://lari.jumpstart.ge/en/api/v1/calculator?currency=USD&amp;amount=1000&amp;direction=1&amp;start_date=1420070400000&amp;end_date=1422748800000</a></div>
<pre class="brush:js;auto-links:false;toolbar:false" contenteditable="false">{
  valid: true,
  currency: {
    from: "USD",
...
<div class="url"><a href="/en/api/v1/calculator?currency=USD&amp;amount=1000&amp;direction=0&amp;start_date=1420070400000&amp;end_date=1422748800000" target="_blank">http://lari.jumpstart.ge/en/api/v1/calculator?currency=USD&amp;amount=1000&amp;direction=0&amp;start_date=1420070400000&amp;end_date=1422748800000</a></div>
<pre class="brush:js;auto-links:false;toolbar:false" contenteditable="false">{
  valid: true,
  currency: {
    from: "GEL",
...
<tr>
<td>currency</td>
<td>ვალუტის კოდი (მაგ., USD)</td>
</tr>
<tr>
<td>amount</td>
<td>გაუფასურების გამოსათვლელი თანხის რაოდენობა</td>
</tr>
<tr>
<td>direction</td>
<td>უთითებს, თუ რომელ ვალუტაშია თანხა და რომელში უნდა დაკონვერტირდეს
<ul>
...
<tr>
<td>start_date</td>
<td>საწყისი თარიღი, საიდანაც მიიღება ინფორმაცია გაცვლითი კურსის შესახებ,  UTC ფორმატში (მაგ., 1422748800000 არის UTC თარიღი 2015-01-01-სთვის) <a href="http://www.w3schools.com/jsref/jsref_utc.asp" target="_blank">UTC-ს თარიღების შესახებ დამატებითი ინფორმაციის მიღება შესაძლებელია ამ ბმულზე</a>.</td>
</tr>
<tr>
<td>end_date</td>
<td>საბოლოო თარიღი, სადამდეც მიიღება ინფორმაცია გაცვლითი კურსის შესახებ, UTC ფორმატში (მაგ., 1422748800000 არის UTC თარიღი 2015-01-01-სთვის) <a href="http://www.w3schools.com/jsref/jsref_utc.asp" target="_blank">UTC-ს თარიღების შესახებ დამატებითი ინფორმაციის მიღება შესაძლებელია ამ ბმულზე.</a></td>
</tr>
</tbody>
</table>
<h2>არჩევითი პარამეტრები</h2>
<p>გამოძახებისთვის არ არის საჭირო არჩევითი  პარამეტრები.</p>
<h2>რას მიიღებთ</h2>
<p>დაბრუნებული ობიექტი არის JSON, რომელიც გვაჩვენებს საწყის და საბოლოო კურსებს და მოგებული ან დაკარგული თანხის ოდენობას.</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
<tr><th>პარამეტრი</th><th>აღწერა</th></tr>
</thead>
...
<li><strong>end</strong> - გაცვლითი კურსი საბოლოო თარიღის დროს</li>
</ul>
</td>
</tr>
<tr>
<td>amount</td>
<td>
<p>ოთხი ღირებულების მიღება:</p>
<ul>
<li><strong>original</strong> - თქვენ მიერ მოთხოვნილი თავდაპირველი თანხა</li>
<li><strong>start</strong> - საწყისი თარიღის დროს არსებული თანხის რაოდენობა, გაცვლითი კურსის მოთხოვნის შემდეგ</li>
<li><strong>end</strong> - ბოლო თარიღის დროს არსებული თანხის რაოდენობა, გაცვლითი კურსის მოთხოვნის შემდეგ</li>
